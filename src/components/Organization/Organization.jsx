...
function Organization() {
  ...
  return (
    <div className="min-h-screen bg-gray-900  p-4 w-full">
        <div className="max-w-2xl mx-auto p-6 my-20 bg-purple-800/20 text-white rounded-lg shadow-md">
        <h2 className="text-2xl font-bold mb-6 text-white">Organization Information</h2>
        ...
        <div>
          ...
          <div className="mb-4">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <p className="text-xs text-white/70">Select an image file for your organization's logo</p>
            </div>
          </div>
          ...
          <div className="mb-4">
            <label htmlFor="employeeCount" className="block text-white font-medium mb-2">
          ...
          <div className="mb-6">
            <div className="flex items-center">
              ...
              />
              <label htmlFor="isActive" className="ml-2 block text-white font-medium">
