      ...
      <div className="flex items-center justify-between h-full">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="h-10 w-10">
            <img src='hyprps 1.png' alt='HyperPOS Logo' className="h-full w-auto object-contain" />
          </div>
          ...
          <div className="relative profile-menu-container">
            ...
            >
              <div className="h-8 w-8 bg-white rounded-full flex items-center justify-center">
                <span className="text-[#70317d] text-sm font-bold">C</span>
              </div>
              <span className="hidden sm:inline-block text-sm">Cashier User</span>
              <IoMdArrowDropdown />
            </button>
            ...
            {showProfileMenu && (
              <div className="absolute right-0 top-full mt-1 w-48 bg-white rounded-md shadow-lg py-3 px-4 z-10">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-medium text-sm">Cashier User</div>
                    <div className="text-xs text-gray-500">cashier@hyperpos.com</div>
                  </div>
                </div>
              </div>
            )}
