...
function SideBar({ isExpanded: propIsExpanded, toggleSidebar: propToggleSidebar }) {
  ...
  return (
    <div className={`bg-[#81679e] h-full flex flex-col ${isExpanded ? 'w-56' : 'w-20'} transition-all duration-300`}>
