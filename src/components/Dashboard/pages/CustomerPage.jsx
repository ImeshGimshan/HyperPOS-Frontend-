          ...
          <div className = "bg-blue-50 p-3 rounded-lg">
            ...
            <div className = "grid grid-cols-1 gap-3 text-sm">
              <div className = "flex flex-col">
                ...
                <span className = "p-2 bg-white rounded-md">{ customer.email || "Not provided" }</span>
              </div>
              <div className = "flex flex-col">
                <span className = "font-medium text-gray-600">Phone</span>
                <span className = "p-2 bg-white rounded-md">{ customer.phone || "Not provided" }</span>
              </div>
              <div className = "flex flex-col">
                <span className = "font-medium text-gray-600">Address</span>
                <span className = "p-2 bg-white rounded-md whitespace-pre-wrap">{ customer.address || "Not provided" }</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <tbody>
            { filteredData.map ( ( customer ) => (
              ...
              <tr key = { customer.id } className = "border-t hover:bg-gray-50 transition duration-200 ease-in-out">
                ...
                <td className = "p-3 truncate max-w-[200px]">{ customer.address || "—" }</td>
