      ...
      <div className = "bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden relative">
        ...
        <div className = "px-6 py-4 border-b border-gray-100">
          <div className = "w-full text-center">
            <h2 className = "text-2xl font-bold text-purple-900">Sale Details</h2>
          </div>
          <button
            onClick = { onClose }
          ...
          <div className = "max-h-[60vh] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-purple-50 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-purple-300 hover:[&::-webkit-scrollbar-thumb]:bg-purple-400 p-6">
            <div className = "space-y-5">
              ...
              <div className = "bg-purple-50 p-4 rounded-xl">
                <h3 className = "text-md font-semibold text-purple-800 mb-3 text-center">Invoice Information</h3>
              ...
              <div className = "bg-green-50 p-4 rounded-xl">
                <h3 className = "text-md font-semibold text-green-800 mb-3 text-center">Financial Information</h3>
              ...
              <div className = "bg-blue-50 p-4 rounded-xl">
                <h3 className = "text-md font-semibold text-blue-800 mb-3 text-center">Items ({ sale.items.length })</h3>
...
function SalePage ( ) {
  ...
  const customerList = [...new Set ( saleData.map ( sale => sale.invoice.customerId ) ) ];
  const paymentMethods = [...new Set ( saleData.map ( sale => sale.invoice.paymentMethod ) ) ];
  ...
  const filteredData = saleData.filter ( ( sale ) => {
    ...
    // Apply filters
    const matchesCustomerId = !filters.customerId || sale.invoice.customerId.toString ( ) === filters.customerId;
    const matchesPaymentMethod = !filters.paymentMethod || sale.invoice.paymentMethod === filters.paymentMethod;
    
    const matchesTotal = 
      ( !filters.minTotal || sale.invoice.total >= Number ( filters.minTotal ) ) && 
      ( !filters.maxTotal || sale.invoice.total <= Number ( filters.maxTotal ) );
  ...
  return (
    ...
    <div className = "p-6">
      <h1 className = "text-3xl font-bold mb-6 text-purple-900 text-center">Sales Management</h1>
              ...
              { filteredData.length > 0 ? (
                filteredData.map ( ( sale ) => (
                  <tr key = { sale.invoice.id } className = "border-t hover:bg-gray-50 transition duration-200 ease-in-out">
                    ...
                    <td className = "p-3">{ sale.invoice.paymentMethod }</td>
                    ...
                    <td className = "p-3">{ formatDate ( sale.invoice.updatedAt ) }</td>
