...
return (
    ...
    <div className = "bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden relative">
        ...
        <div className = "w-full text-center">
            <h2 className = "text-2xl font-bold text-purple-900">Purchase Details</h2>
        </div>
        <button
            onClick = { onClose }
        ...
        <div className = "max-h-[60vh] overflow-y-auto [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-purple-50 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-purple-300 hover:[&::-webkit-scrollbar-thumb]:bg-purple-400 p-6">
            ...
            <div className = "bg-purple-50 p-4 rounded-xl">
                <h3 className = "text-md font-semibold text-purple-800 mb-3 text-center">Purchase Information</h3>
            ...
            <div className = "bg-blue-50 p-4 rounded-xl">
                <h3 className = "text-md font-semibold text-blue-800 mb-3 text-center">Items ({ purchase.items.length })</h3>
...
const filteredData = purchaseData.filter((purchase) => {
  ...
  return (
    ...
    <div className = "p-6">
      <h1 className = "text-3xl font-bold mb-6 text-purple-900 text-center">Purchases Management</h1>
              ...
              { filteredData.length > 0 ? (
                filteredData.map ( ( purchase ) => (
                  <tr key = { purchase.grn.id } className = "border-t hover:bg-gray-50 transition duration-200 ease-in-out">
                    ...
                    <td className = "p-3">{ formatDate ( purchase.grn.updatedAt ) }</td>
