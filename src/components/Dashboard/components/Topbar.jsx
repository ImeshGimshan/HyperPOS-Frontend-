  ...
  return (
    <header className = "h-14 sm:h-16 shadow flex items-center justify-between px-2 sm:px-4 md:px-6 text-xs sm:text-sm text-gray-100 relative hyper-bg-horizontal border-b border-purple-800/30">
      ...
      <div className = "flex items-center relative z-10">
        ...
        <button
          type = "button"
          className = "text-white p-1 sm:p-2 rounded-md lg:hidden focus:outline-none hyper-button mr-1 sm:mr-2"
          onClick = { onMenuToggle }
          aria-label = "Toggle sidebar menu"
        >
          <Menu size = { 20 } className = "hyper-icon" />
        </button>
      ...
      <div className = "flex justify-end relative z-10">
        ...
        >
          ...
          <span className = "hidden sm:inline hyper-text">Logout</span>
        </HyperPOSButton>
      </div>
